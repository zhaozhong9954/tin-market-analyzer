            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                <div className="bg-slate-950 border border-slate-800 p-6 lg:p-8 rounded-[2rem] lg:rounded-[3rem] shadow-2xl overflow-hidden text-left">
                  <h3 className="text-sm font-bold text-white flex items-center gap-2 mb-6 italic text-left"><BarChart3 size={18} className="text-blue-500" /> LME 3M Price Trend</h3>
